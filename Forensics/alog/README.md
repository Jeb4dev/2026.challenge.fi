...
We have a suspicion that someone has made some odd requests to our server. Can you find the flag?

Remember that the flag format is DDC{}

[Download](https://nextcloud.haaukins.com/s/9wpt7Xwc2L89c42/download/forensics_access.log.zip)
sha256: afa319b9b44775af9065337067db74081965ea5d07d9689742b4246becd8e5d3

## Solution

Open the file and search for the string "DDC{" to find the flag.

We find ``s0me_base64_c0de_DDC{Tim3_Tr4v3l`` from ``192.168.1.99``

There is another request from the same ip to ``/files/temp/_L0g_An4lys1s}/page.php``

Combining the start and enf of the flag, we get `DDC{Tim3_Tr4v3l_L0g_An4lys1s}`

````log
10.0.0.9 - - [28/Nov/2025:14:33:45 +0100] "GET /css/styles.css HTTP/1.1" 404 1790 "http://google.com/" "Mozilla/5.0 (Linux; Android 10; SM-G973F)"
...
10.0.0.6 - - [28/Nov/2025:14:34:01 +0100] "GET /images/logo.png HTTP/1.1" 200 2551 "-" "Mozilla/5.0 (compatible; Googlebot/2.1)"
````
